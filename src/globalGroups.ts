...
export default defineGkdGlobalGroups([
  {
    key: 0,
    name: '开屏广告-极速全局跳过',
    desc: '启动阶段优先使用精确 text/vid 快速查询，节点一进入无障碍树就立即点击；微信已由模块接管，因此排除微信。',
    categoryKey: 0,
    fastQuery: true,
    order: -1000,
    matchTime: 10000,
    ...
    resetMatch: 'app',
    actionCd: 200,
    apps: [{ id: 'com.tencent.mm', enable: false }],
    rules: [
      {
        key: 0,
        name: '极速-跳过',
        matches: '@[text="跳过"][width<500][height<300][visibleToUser=true]',
      },
      {
        key: 1,
        name: '极速-跳过广告',
        matches: '@[text="跳过广告"][width<500][height<300][visibleToUser=true]',
      },
      {
        key: 2,
        name: '极速-跳 过',
        matches: '@[text="跳 过"][width<500][height<300][visibleToUser=true]',
      },
      {
        key: 3,
        name: '极速-繁体跳過',
        matches: '@[text="跳過"][width<500][height<300][visibleToUser=true]',
      },
      {
        key: 10,
        name: '极速-穿山甲开屏ID',
        matches: '@[vid="tt_splash_skip_btn"][width<500][height<300][visibleToUser=true]',
      },
      {
        key: 11,
        name: '极速-splash_skip_button',
        matches: '@[vid="splash_skip_button"][width<500][height<300][visibleToUser=true]',
      },
      {
        key: 12,
        name: '极速-btn_skip',
        matches: '@[vid="btn_skip"][width<500][height<300][visibleToUser=true]',
      },
      {
        key: 13,
        name: '极速-skip_view',
        matches: '@[vid="skip_view"][width<500][height<300][visibleToUser=true]',
      },
      {
        key: 14,
        name: '极速-ms_skipView',
        matches: '@[vid="ms_skipView"][width<500][height<300][visibleToUser=true]',
      },
      {
        key: 20,
        name: '快速-短文本兜底',
